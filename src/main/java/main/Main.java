...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        inventories[2] = new SizableInventory("Coat", LocalDate.of(2019, 6, 1), 5500.6, ProductCategory.CLOTHES, 142.5);
        inventories[3] = new SizableInventory("Hat", LocalDate.of(2019, 4, 26), 730.8, ProductCategory.CLOTHES, 52.6);
        ...
        System.out.println(shop.stocks); // prints list of stocks in shop
        ...
        shop.createOrder(inventories[2], 5, shop.consumers.get(0), shop.customers.get(0));
        System.out.println("-------------------------");
        System.out.println(shop);
        ...
        shop.createOrder(inventories[4], 15, shop.consumers.get(0), shop.customers.get(0));
        System.out.println("-------------------------");
        System.out.println(shop);
        ...
        shop.createOrder(inventories[1], 5, shop.consumers.get(0), shop.customers.get(0));
        System.out.println("-------------------------");
        System.out.println(shop);
    }
}
